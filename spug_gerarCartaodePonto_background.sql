...
-- =============================================
ALTER PROCEDURE [dbo].[spug_gerarCartaodePonto_background] 
...
BEGIN
	...
	select @sit_f = funcscodigo, @pis = funcipis from tbgabfuncionario (nolock) where funcicodigo = @funcicodigo
