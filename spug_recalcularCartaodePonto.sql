		...
		begin
				...
				begin
					...
					begin
						...
						select top 1 @cartadesconsiderapreassinalado=cartadesconsiderapreassinalado,@h_referencia=cartahorarreferencia from tbgabcartaodeponto (nolock) where cartacodigo = @cartacodigo
						...
						where cartacodigo = @cartacodigo --cartadatajornada = @dt and funcicodigo = @funcicodigo
						...
						exec dbo.spug_incluirTotalizadores @acordcodigo, @funcicodigo, @dt, 'spug_recalcularCartaodePonto'
						...
						--insert into @tabela_auxiliar values (@dt,@count,@contadorafd,@contadorcartaodeponto,@dt_auxiliar,@ult_apt)	
					end
